...
Source0:	http://download.savannah.gnu.org/releases/freetype/%{realname}-%{version}.tar.xz
# Source0-md5:	7c0d5a39f232d7eb9f9d7da76bf08074
URL:		http://www.freetype.org/
BuildRequires:	crossmingw32-bzip2
BuildRequires:	crossmingw32-gcc
%{?with_harfbuzz:BuildRequires:	crossmingw32-harfbuzz >= 1.8.0}
...
%{?with_harfbuzz:Requires:	crossmingw32-harfbuzz >= 1.8.0}
...
%{?with_harfbuzz:Requires:	crossmingw32-harfbuzz-dll >= 1.8.0}
